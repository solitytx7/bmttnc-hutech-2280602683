...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.txt_key.setGeometry(QtCore.QRect(110, 180, 351, 31))
        self.txt_key.setObjectName("txt_key")
        self.label = QtWidgets.QLabel(self.centralwidget)
        self.label.setGeometry(QtCore.QRect(180, 30, 171, 61))
        font = QtGui.QFont()
        ...
        self.btn_decrypt.setObjectName("btn_encrypt")
        self.label_3 = QtWidgets.QLabel(self.centralwidget)
        self.label_3.setGeometry(QtCore.QRect(30, 180, 47, 13))
        self.label_3.setObjectName("label_3")
        self.btn_encrypt = QtWidgets.QPushButton(self.centralwidget)
        self.btn_encrypt.setGeometry(QtCore.QRect(160, 330, 75, 23))
        self.btn_encrypt.setObjectName("btn_decrypt")
        self.txt_cipher_text = QtWidgets.QPlainTextEdit(self.centralwidget)
        self.txt_cipher_text.setGeometry(QtCore.QRect(110, 230, 351, 71))
